 ...
 * keyou项目创建项目列表用例
 */
public class KeyouCreateProjects extends BaseCase {

    private static Logger logger = Logger.getLogger(KeyouCreateProjects.class);

    @Test(dataProvider = "datas",description = "keyou创建项目列表description属性")
    ...
    public void test(CaseInfo caseInfo) {
        ...
        //  2.1、获取带token的请求头
        Map<String, String> headers = AuthenticationUtils.getKeyouTokenHeader();

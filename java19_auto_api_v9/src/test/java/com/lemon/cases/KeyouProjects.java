 ...
 * keyou项目项目列表用例
 */
public class KeyouProjects extends BaseCase {

    private static Logger logger = Logger.getLogger(KeyouProjects.class);

    @Test(dataProvider = "datas",description = "keyou项目列表description属性")

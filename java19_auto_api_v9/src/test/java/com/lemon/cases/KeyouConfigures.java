 ...
 * keyou项目配置列表用例
 */
public class KeyouConfigures extends BaseCase {

    private static Logger logger = Logger.getLogger(KeyouConfigures.class);

    @Test(dataProvider = "datas",description = "keyou配置列表description属性")

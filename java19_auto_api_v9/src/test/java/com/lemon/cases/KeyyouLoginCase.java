 ...
 * keyou项目登录用例
 */
public class KeyyouLoginCase extends BaseCase {

    private static Logger logger = Logger.getLogger(KeyyouLoginCase.class);

    @Test(dataProvider = "datas",description = "keyou登录测试description属性")
    ...
    public void test(CaseInfo caseInfo) {
        ...
        //  3.1、从响应体里面获取token
        AuthenticationUtils.json2Vars(body,"$.token","${token}");
